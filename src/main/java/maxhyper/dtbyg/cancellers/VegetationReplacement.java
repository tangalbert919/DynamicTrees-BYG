...
public class VegetationReplacement {
    ...
    public static final BlockPredicateFilter SAND_FILTER = BlockPredicateFilter.forPredicate(BlockPredicate.matchesTag(BlockTags.SAND));
    public static RegistryObject<ConfiguredFeature<?,?>> WINDSWEPT_DESERT_VEGETATION =
            CONFIGURED_FEATURES.register("windswept_desert_vegetation_no_vanilla_cacti",
                    () -> new ConfiguredFeature<>(Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(ImmutableList.of(
                            new WeightedPlacedFeature(BYGPlacedFeaturesUtil.createPlacedFeatureDirect(BYGOverworldVegetationFeatures.MINI_CACTI, SAND_FILTER), 0.15F),
                            new WeightedPlacedFeature(BYGPlacedFeaturesUtil.createPlacedFeatureDirect(BYGOverworldVegetationFeatures.PRICKLY_PEAR_CACTI, SAND_FILTER), 0.15F),
                            new WeightedPlacedFeature(BYGPlacedFeaturesUtil.createPlacedFeatureDirect(BYGOverworldVegetationFeatures.ALOE_VERA, SAND_FILTER), 0.3F)
                    ), BYGPlacedFeaturesUtil.createPlacedFeatureDirect(BYGOverworldVegetationFeatures.GOLDEN_SPINED_CACTI, SAND_FILTER))));
